...
function getPetData(){
	...
	//alert(petId);
	 $.ajax({
		  ...
		  url:"http://localhost/petPhotoData.php",
...
function getPetPhotos(arrOptions , array){
	...
	//alert(petId);
	 $.ajax({
		  type: "POST",
		  data: {petType : petType},
		  url:"http://localhost/GetPetType.php",
		  success: function(data){
 ...
 function addPetInput(arrOptions, array, res){
	     ...
	     for(var i = 0; i < arrOptions.length; i++){
			 ...
			 img.src = hi;
			    	...
			    	img.setAttribute("style", "margin-top: -280px; width:700px; height:500px; background-color: #CFCCC9; padding: 20px;");
			    	img.src = hi;
